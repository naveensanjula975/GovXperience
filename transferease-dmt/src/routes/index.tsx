...
// import AddAdmin from '../pages/dashboards/AddAdmin';
...
const Transfers = React.lazy(() => import('../pages/dashboards/Transfers/'));
const Vehicles = React.lazy(() => import('../pages/dashboards/Vehicles/'));
const Owners = React.lazy(() => import('../pages/dashboards/Owners/'));
const AddAdmin = React.lazy(() => import('../pages/dashboards/AddAdmin/'));
const Notifications = React.lazy(() => import('../pages/dashboards/Notifications/'));
  ...
  return useRoutes([
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: 'owners',
          element: <LoadComponent component={Owners} />,
        },
        {
          path: 'notifications',
        ...
        {
          path: 'add-admin',
          element: <LoadComponent component={AddAdmin} />,
        },
        {
          path: 'apps',
          children: [

  ...
  return (
    <div className='invitationcardComponent'>
      <div className="descText">
        <strong className='description'>Welcome to our vehicle transfer request service! Please insert the registration number of your requesting vehicle here to start the smooth transition of your vehicle's ownership. Afterward, the owner of the vehicle will concern on your request.</strong>
      </div>
